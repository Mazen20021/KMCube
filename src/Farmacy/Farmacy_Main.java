...
public class Farmacy_Main extends javax.swing.JFrame {
Connection conn;
ResultSet rss = null;
...
private void search(){
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 10, 40, 40));
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(922, 10, 40, 40));
...
if(notestext.getText().equals("Notes:")||notestext.getText().equals("")){
 JOptionPane.showMessageDialog(null,"Please Put Any Notes if There is no note type nan");    
    ...
    Med m = new Med(medname.getText(),statef.getText(),medcode.getText(),quantity.getText(),expdate.getText(),drid.getText(),drname.getText(),notestext.getText(),"Insert");
     medcode.setText("Medicine Code");
     expdate.setText("Expiry Date");
     medname.setText("Medicine Name");
     quantity.setText("Quantity");         
...
public void update(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Farmacy_Main().setVisible(true);
            }
        });
    }
