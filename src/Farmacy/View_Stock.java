package Farmacy;
import Farmacy.Medicine.SearchDrID;
import Main.Main;
...
int y = 0;
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 10, 40, 40));
    ...
    private void showtableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showtableActionPerformed
     SearchDrID sdr = new SearchDrID(Dr_ID.getText(),jPasswordField1.getText(),jTable1);
